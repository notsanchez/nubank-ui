...
const Remove = (props) => {
    ...
    const finalvalue = Number(atualbalance) - Number(removeValue)
  ...
  return (
    ...
    className='flex flex-col items-center justify-center w-screen h-screen'>
        ...
        <Link to="/" className='flex'>
            ...
            <h1 className='text-lg font-semibold text-red-500'>Remover saldo</h1>
            ...
            <div className='flex flex-col mt-4 text-bgColor gap-2 text-sm font-semibold'>
                <Link to="/add">Adicionar saldo</Link>
            </div>
        </div>
    </motion.div>
  )
